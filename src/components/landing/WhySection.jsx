  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
        {/* Images */}
        <div className="relative w-full h-[18rem] sm:h-[22rem] md:h-[26rem] [perspective:1000px]" ref={imageContainerRef}>
...
export default function WhySection() {
  ...
  const middleOpacity = useTransform(scrollProgress, [0.0, 0.05, 0.7, 1.0], [0, 0, 1, 1]);
  const middleY = useTransform(scrollProgress, [0.0, 0.05, 0.7, 1.0], [380, 380, 0, 0]);
  const middleScale = useTransform(scrollProgress, [0.0, 0.05, 0.7, 1.0], [0.96, 0.96, 1, 1]);
  ...
  return (
    <>
      ...
      >
        <div className="sticky top-0 h-screen w-full overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-8 md:px-12 h-full flex flex-col justify-center py-[6vh] lg:py-[8vh]">
            ...
            {/* Section Header */}
            <div className="text-center mb-[5vh] max-w-2xl mx-auto">
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold text-[#1E5028] dark:text-white tracking-tight animate-none">
                A Growth Partner, Not Just a Vendor
              </h2>
              <p className="text-sm text-neutral-600 dark:text-neutral-400 mt-3 leading-relaxed">
                We combine end-to-end expertise with local insights and data-backed strategies to help your business excel in today's digital landscape.
              </p>
            </div>
      ...
      {/* ==================================================== */}
      {/* 3. TESTIMONIALS SECTION (Sequential Desktop/Mobile unified) */}
      {/* ==================================================== */}
      <section className="relative overflow-hidden py-24 sm:py-32 bg-background text-foreground transition-colors duration-300 z-10 border-t border-black/5 dark:border-white/5 select-none">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 flex flex-col items-center">
          ...
          <CircularTestimonials testimonials={testimonialsData} isDark={isDark} />
        </div>
      </section>
    </>
  );
