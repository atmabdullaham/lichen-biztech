        ...
        >
          {testimonials.map((testimonial) => (
            <motion.div
              ...
              className="group relative rounded-2xl border border-[#85C441]/10 bg-white/80 p-8 shadow-sm backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-[#85C441]/5"
            >
              {/* Quote icon */}
              <Quote className="mb-4 h-8 w-8 text-[#85C441]/20" />
              ...
              {/* Quote text */}
              <p className="mb-6 leading-relaxed text-[#4A5568] italic">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-sm font-semibold text-[#1E5028]">
                    {testimonial.name}
                  </div>
                  <div className="text-xs text-[#7A8B95]">
